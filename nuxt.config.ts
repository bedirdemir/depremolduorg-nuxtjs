...
export default defineNuxtConfig({
  app: {
    head: {
      ...
      meta: [
        {charset: 'utf-8'},
        {property: 'og:title', content:'Son Depremler ve Deprem Haritası - Deprem Oldu'},
        {property: 'og:description', content: "Türkiye'de gerçekleşen son depremler. Türkiye deprem haritası. Deprem ve Afet Bilinci Hakkında Bilmeniz Gerekenler. DepremOldu.org - Deprem Oldu"},
        {property: 'og:url', content: 'https://www.depremoldu.org'},
        {property: 'og:image', content: 'https://www.depremoldu.org/logo-social.jpg'},
